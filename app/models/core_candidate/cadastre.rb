module CoreCandidate
  class Cadastre < ApplicationRecord
    ...
    has_many :exemptions,   primary_key: :cpf, foreign_key: :cpf, class_name: "CoreCandidate::Sefaz::Exemption"

    has_many :occurrences, class_name: "CoreCandidate::CadastreOccurrence"
    has_many :ammvs
    ...
    has_many :enterprise_cadastres, foreign_key: "cadastre_id", class_name: "CoreCandidate::EnterpriseCadastre"

    has_many :invoices, class_name: "CoreCandidate::Brb::Invoice", foreign_key: :cpf, primary_key: :cpf
    ...
    has_many :old_candidates, class_name: 'CoreCandidate::Entity::OldCandidate'
    has_many :olds, through: :old_candidates, class_name: "CoreCandidate::Entity::Old"
